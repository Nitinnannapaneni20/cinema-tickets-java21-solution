...
class TicketServiceIntegrationTest {
    ...
    @Test
    void shouldCalculateCorrectCostAndSeatsForAdults() {
    ...
    @Test
    void shouldHandleFamilyWithAdultChildAndInfant() {
        TicketTypeRequest adultRequest = new TicketTypeRequest(TicketTypeRequest.Type.ADULT, 2);
    ...
    @Test
    void testMoreThanOneInfantPerAdultFails() {
        TicketTypeRequest adultRequest = new TicketTypeRequest(TicketTypeRequest.Type.ADULT, 1);
    ...
    @Test
    void shouldAllowOneInfantPerAdult() {
        TicketTypeRequest adultRequest = new TicketTypeRequest(TicketTypeRequest.Type.ADULT, 2);
        TicketTypeRequest infantRequest = new TicketTypeRequest(TicketTypeRequest.Type.INFANT, 2);
    ...
    @Test
    void shouldHandleComplexFamilyWithAllTicketTypes() {
    ...
    @Test
    void shouldRejectTwentySixInfantsExceedingLimit() {
    ...
    @Test
    void shouldRejectTwentySixChildrenExceedingLimit() {
